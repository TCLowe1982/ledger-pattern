...
**Implementing this in your own work?** A self-contained, actionable recipe —
trigger, parameter defaults, algorithm, and invariants — lives in
**[ledger-agent.md](ledger-agent.md)**. The rest of this document is the
reasoning behind each step; read it when a choice is unclear.
